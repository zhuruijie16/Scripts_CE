...
for file in file_order:
    ...
    ## loc_E_diff
    loc_E_diff = []
    for sep_df in sep_diff:
        loc_E_diff.append(loc_E[sep.index(sep_df)])
    ...
    #1/dist_sum for each sep_diff - j=1-NN
    for NN in range(1,6): #change
        dist_inv_sum=[]
        for i,e_diff in enumerate(E_diff):
            ...
            for j in range(NN):
                ...
                if dup[sep_sum_before+j]==1:
                    ...
                    print(f'E_num[sep_sum_before+j]:{E_num[sep_sum_before+j+lag]}')
                    print(f'sum:{sum}')
                else:
                    for k in range(dup[sep_sum_before+j]):
                        ...
                        print(f'dist[sep_sum_before+j]:{dist[sep_sum_before+j]}')
                        print(f'E_num[sep_sum_before+j+k]:{E_num[sep_sum_before + j+k+lag]}')
                        print(f'sum:{sum}')
        ...
        for i,e_diff in enumerate(E_diff):
            ...
            for j in range(NN):
                ...
                if dup[sep_sum_before+j]==1:
                    ...
                    for k in range(dup[sep_sum_before+j]):
                        #print(dup[sep_sum_before+j])
                        #print(f'lag:{lag}')
                        #print(f'dist[sep_sum_before+j]:{dist[sep_sum_before+j]}')
                        #print(f'E_num[sep_sum_before+j+k:{E_num[sep_sum_before+j+k]}')
